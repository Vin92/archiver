...
/*  Формат массива блоков:
    sizeBlockArray - количество блоков в массиве;
    blockArray[i] - максимальный возможный индекс, принадлежащий данному блоку.
*/
...
(unsigned newIndex,unsigned oldIndex)
{
    ...
    1: new больше old
    -1: new меньше old
    n: совпадение в n символах, new больше old
    -n: new меньше old
    */
    ...
    /* Здесь может быть баг, так как возвращается ноль */
    char first,second;
    int counter=0;
    for(i=0; i<rect; i++)
    {
